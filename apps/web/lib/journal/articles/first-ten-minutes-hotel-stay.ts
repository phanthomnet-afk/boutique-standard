...
const article: Article = {
  ...
  title: "The First Ten Minutes of a Hotel Stay Decide Everything That Follows",
  excerpt:
  ...
  seo: {
    title: "The First Ten Minutes of a Hotel Stay - The Boutique Standard",
    description:
      "Arrival is the phase of highest emotional sensitivity in the guest journey. Most boutique hotels underinvest in it precisely because it feels operational rather than experiential.",
  },
  keyTakeaways: [
  ...
  relatedSlugs: [
    ...
    "qualities-boutique-hotels-memorable-first-to-go",
  ],
  faqs: [
    {
      question: "Why do guests mention arrival so often in hotel reviews?",
      answer:
        "Arrival is when guests compare their anticipation against reality for the first time. Friction during arrival creates a lasting impression that influences how guests interpret every subsequent touchpoint - including ones that would otherwise be rated positively.",
    },
    {
      question: "What is the most common arrival failure in boutique hotels?",
      answer:
        "Unclear wayfinding between parking and reception is consistently the most cited arrival friction point. Guests who experience uncertainty before they reach the front desk arrive in a state of mild anxiety rather than calm anticipation.",
    },
    {
      question: "How can a boutique hotel improve its arrival experience?",
      answer:
        "The highest-impact improvements are typically low-cost: pre-arrival communication with clear directions, discreet directional signage, and a protocol for acknowledging arriving guests within thirty seconds of entry.",
    },
    {
      question: "Does arrival experience affect online reviews?",
      answer:
        "Yes. Arrival experience is one of the strongest predictors of overall review sentiment - even when guests rate the room and dining positively. A weak arrival creates a deficit of goodwill that minor subsequent failures cannot overcome.",
    },
  ],
  blocks: [
    {
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Why arrival is different from every other touchpoint",
    },
    {
      type: "text",
      paragraphs: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "What happens when arrival creates uncertainty",
    },
    {
      type: "text",
      paragraphs: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "The arrival phases most properties overlook",
    },
    {
      type: "text",
      paragraphs: [
    ...
    {
      type: "insight",
      text: "The warmth of the welcome cannot fully recover from the anxiety of the approach.",
    },
    {
      type: "heading",
      level: 2,
      text: "What a strong arrival actually creates",
    },
    {
      type: "text",
      paragraphs: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "The arrival experience in practice",
    },
    {
      type: "text",
      paragraphs: [
    ...
    {
      type: "insight",
      text: "Arrival is not the beginning of the stay. It is the frame through which the rest of the stay is seen.",
    },
    {
      type: "cta",
      label: "See it clearly",
      text: "Arrival is one of the first things we evaluate. It is almost always where the gaps begin.",
