...
const article: Article = {
  ...
  seo: {
    title: "The Boutique Hotel Guest Has Changed - The Boutique Standard",
    description:
      "Boutique hotel guests now prioritise coherence over design. Understanding this shift is the difference between a property that earns loyalty and one that earns one-time visits.",
  },
  keyTakeaways: [
  ...
  faqs: [
    {
      question: "What do boutique hotel guests value most today?",
      answer:
        "Boutique hotel guests increasingly value consistency and coherence over individual luxury moments. Guests who experience alignment between a property's communicated promise and their actual stay are significantly more likely to return and recommend the property to others.",
    },
    {
      question: "Why are boutique hotel guests leaving more qualified reviews?",
      answer:
        "Guests are becoming more precise in their evaluations. A property that delivers a beautiful room but an inconsistent service experience receives reviews that reflect the gap - even when no single element was significantly below standard.",
    },
    {
      question: "What is experience coherence in hospitality?",
      answer:
        "Experience coherence refers to the consistency of feeling and quality across every touchpoint of a hotel stay. A property with high experience coherence delivers the same character and attentiveness at check-in, poolside, at breakfast, and at departure.",
    },
    {
      question: "How can a boutique hotel understand its own guest experience?",
      answer:
        "The most accurate understanding comes from evaluation conducted as a standard first-time guest. Internal reviews and guest surveys measure a filtered version of the experience. Independent evaluation removes that filter.",
    },
  ],
  blocks: [
    {
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "What boutique hotel guests used to want",
    },
    {
      type: "text",
      paragraphs: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "What those reviews are actually saying",
    },
    {
      type: "text",
      paragraphs: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "The shift that most properties have not made",
    },
    {
      type: "text",
      paragraphs: [
    ...
    {
      type: "insight",
      text: "Design gets guests through the door. Coherence gets them back.",
    },
    {
      type: "heading",
      level: 2,
      text: "What this means for a boutique property today",
    },
    {
      type: "text",
      paragraphs: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "The properties getting this right",
    },
    {
      type: "text",
      paragraphs: [
    ...
    {
      type: "insight",
      text: "You cannot evaluate your own guest experience. You are too close to it.",
    },
    {
      type: "cta",
      label: "The Boutique Standard Audit",
      text: "Understanding your guest experience from the outside is the first step toward improving it.",
